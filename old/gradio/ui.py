...
# from modules.StableDiffusionPlugins_samplers import samplers, samplers_for_img2img
# from modules.StableDiffusionPlugin_hijack import model_hijack
# import modules.LDSRPlugin
# import modules
# import modules.GFPGANPlugin
# import modules.CodeformerPlugin
...
#                 shared.state.current_image = sd_samplers.sample_to_image(shared.state.current_latent)
...
#
#                 with gr.Group():
#                     custom_inputs = modules.scripts_txt2img.setup_ui(is_img2img=False)
#
#             with gr.Column(variant='panel'):
#
#                 with gr.Group():
...
#
#                 with gr.Group():
#                     custom_inputs = modules.scripts_img2img.setup_ui(is_img2img=True)
#
#             with gr.Column(variant='panel'):
#
#                 with gr.Group():
...
#             restart_gradio = gr.Button(value='Restart Gradio and Refresh components (Custom Scripts, TextinvUI_old.py, js and css only)', variant='primary')
#
#         def reload_scripts():
#             modules.reload_body_only()
#
