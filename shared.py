...
parser.add_argument("--hypernetwork-dir", type=str, default=os.path.join(models_path, 'modules/hypernetworks'), help="hypernetwork directory")
...
# artist_db = plugins.artists.ArtistsDatabase(os.path.join(script_path, 'artists.csv'))
# interrogator = plugins.interrogate.InterrogateModels("interrogate")
