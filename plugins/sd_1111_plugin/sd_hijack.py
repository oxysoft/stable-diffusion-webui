...
import prompt_parser, devices, sd_hijack_optimizations, SDPlugin
...
class StableDiffusionModelHijack:
    ...
    import modules.stable_diffusion_auto1111.sd_textinv
    embedding_db = textual_inversion.textual_inversion.EmbeddingDatabase(modules.stable_diffusion_auto2222.sdpaths.embeddings_dir)
