...
if __name__ == '__main__':
    ...
    testEmbed = Image.open('textual_inversion/test_embedding.png')
    ...
    g = lcg()
    SDPlugin_random = np.array([next(g) for _ in range(100)]).astype(np.uint8).tolist()
    ...
    assert SDPlugin_random == reference_random
