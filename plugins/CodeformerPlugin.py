...
def setup_model(dirname):
    ...
    try:
        ...
        from core.plugins import CodeFormer
        ...
        class FaceRestorerCodeFormer(modules.face_restoration.FaceRestoration):
            ...
            def restore(self, np_image, w=None):
                ...
                for idx, cropped_face in enumerate(self.face_helper.cropped_faces):
                    ...
                    try:
                        with torch.no_grad():
                            output = self.net(cropped_face_t, w=w if w is not None else modules.stable_diffusion_auto2222.options.opts.code_former_weight, adain=True)[0]
                ...
                if modules.stable_diffusion_auto2222.options.opts.face_restoration_unload:
