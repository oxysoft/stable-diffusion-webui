...
from modules import prompt_parser, processing
...
# Current samplers to use
samplers = []
samplers_for_img2img = [] # Samplers only for img2img
...
def sample_to_image(samples):
    x_sample = processing.decode_first_stage(plugins.get('stablediffusion').model, samples[0:1])[0]
