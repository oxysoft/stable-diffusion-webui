...
from modules.StableDiffusion.util import create_random_tensors
...
class SDJob_txt2img(SDJob):
    ...
    def sample(self, conditioning, unconditional_conditioning, seeds, subseeds, subseed_strength):
        ...
        x = create_random_tensors([opt_C, self.firstphase_height // opt_f, self.firstphase_width // opt_f],
                                  seeds=seeds,
                                  subseeds=subseeds,
        ...
        noise = create_random_tensors(samples.shape[1:], seeds=seeds, subseeds=subseeds, subseed_strength=subseed_strength, seed_resize_from_h=self.subseed.resize_from_h, seed_resize_from_w=self.subseed.resize_from_w, p=self)
