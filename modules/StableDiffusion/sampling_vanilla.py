...
class VanillaStableDiffusionSampler(StableDiffusionSampler):
    ...
    def p_sample_ddim_hook(self, x_dec, cond, ts, unconditional_conditioning, *args, **kwargs):
        ...
        if self.mask is not None:
            self.plugin.store_latent(self.init_latent * self.mask + self.nmask * res[1])
        else:
            self.plugin.store_latent(res[1])
