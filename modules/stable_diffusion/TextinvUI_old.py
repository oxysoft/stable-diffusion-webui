...
def sanitize_caption(base_path, original_caption, suffix):
    # we have to sanitize on Windows because certain letters may kill the computer
...
#
#         embedding, filename = plugins.stable_diffusion.textual_inversion.textual_inversion.train_embedding(*args)
#
#         res = f"""
