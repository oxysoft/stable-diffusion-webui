...
if cmd_opts.deepdanbooru:
    from plugins.deepbooru import get_deepbooru_tags

import shared as shared
from plugins.StableDiffusionPlugins_samplers import samplers, samplers_for_img2img
from plugins.StableDiffusionPlugin_hijack import model_hijack
import plugins.LDSRPlugin
import plugins
    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    custom_inputs = plugins.scripts_txt2img.setup_ui(is_img2img=False)
    ...
    with gr.Blocks(analytics_enabled=False) as img2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    custom_inputs = plugins.scripts_img2img.setup_ui(is_img2img=True)
    ...
    with gr.Blocks(analytics_enabled=False) as extras_interface:
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    gfpgan_visibility = gr.Slider(minimum=0.0, maximum=1.0, step=0.001, label="GFPGAN visibility", value=0, interactive=plugins.gfpgan_model.have_gfpgan)
